...
CREATE TABLE Sek_kat_info_hronicne_bolesti (
  kategorija_id  NUMBER PRIMARY KEY,
  napomena       VARCHAR2(4000),
  CONSTRAINT fk_ski_hb FOREIGN KEY (kategorija_id) REFERENCES Sekundarna_kategorija(id)
);

CREATE TABLE Sek_kat_info_lekovi_za_decu (
  kategorija_id  NUMBER PRIMARY KEY,
  napomena       VARCHAR2(4000),
  CONSTRAINT fk_ski_ld FOREIGN KEY (kategorija_id) REFERENCES Sekundarna_kategorija(id)
);

CREATE TABLE Sek_kat_info_biljni_lek (
  kategorija_id  NUMBER PRIMARY KEY,
  napomena       VARCHAR2(4000),
  CONSTRAINT fk_ski_bl FOREIGN KEY (kategorija_id) REFERENCES Sekundarna_kategorija(id)
);
