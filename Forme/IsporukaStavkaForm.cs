...
{
    public partial class IsporukaStavkaForm : Form
    {
        private IsporukaStavka isporukaStavka;

        public IsporukaStavkaForm()
        {
            InitializeComponent();
            isporukaStavka = new IsporukaStavka();
            LoadIsporukaStavkaData();
        }

        public IsporukaStavkaForm(IsporukaStavka isporukaStavka)
        {
            InitializeComponent();
